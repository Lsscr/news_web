        ...
        <div class="edit-info-root" v-if="isShowEdit">
          ...
          <div>
            <el-button
              ...
              >取消</el-button
            >
            <el-button @click="saveInfo" type="primary" size="mini" style="margin-top: 10px; width: 60px"
              >保存</el-button
            >
          </div>
        </div>
      </div>
      <el-button @click="isShowEdit = !isShowEdit" class="edit" type="primary" plain size="small"
        >编辑个人资料</el-button
      >
    </div>
